    ...
    def run(self):
        ...
        while True:
            ...
            if self.option_image is IMAGE_NO:
                ...
                cv2.imwrite("./cam_data/image{0:0>5}.jpg".format(self.count), frame)
                pass
                # 저장
            elif self.option_image is IMAGE_DISPLAY:
                cv2.imwrite("./cam_data/image{0:0>5}.jpg".format(self.count), frame_display)
                pass
                # 저장
...
class FindBlackIce(threading.Thread):
    def __init__(self):
        threading.Thread.__init__(self)
        print("[Thread] Find BlackIce")
